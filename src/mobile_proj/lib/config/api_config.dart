class ApiConfig {
  // Override this without editing source:
  ...
  static String get completeRegistrationUrl =>
      '$baseUrl/complete_registration.php';
  ...
  static String get bookingUpdateStatusUrl =>
      '$baseUrl/booking_update_status.php';
  ...
  static String get getCurrentBookingsUrl =>
      '$baseUrl/get_current_bookings.php';
  ...
  static String get managerRecentActivitiesUrl =>
      '$baseUrl/manager_recent_activities.php';
  ...
  static String get employeeUpdateStatusUrl =>
      '$baseUrl/employee_update_status.php';
  static String get managerBookingsUrl => '$baseUrl/manager_bookings.php';
  static String get allBookingsForEmployeesUrl =>
      '$baseUrl/get_all_bookings_for_employees.php';
  static String get servicesListAllUrl => '$baseUrl/services_list_all.php';
  static String get createDefaultServicesUrl =>
      '$baseUrl/create_default_services.php';
